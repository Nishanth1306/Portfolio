          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                I am {profile.name}, based in {profile.location}. I completed a B.E. in Electrical and Electronics Engineering
                at Karpagam Institute of Technology (2021–2025, CGPA 8.0) and work as a Software Engineer at{' '}
                {profile.employer} (Dec 2024 – present). Professional work started in 2023 with a front-end internship.
              </p>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 bg-blue-50 rounded-xl">
                  ...
                  <div className="text-sm text-slate-600 font-medium">Years since 2023</div>
                </div>
