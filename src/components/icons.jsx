...
export function Linkedin({ className }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M6.5 9H4V20h2.5V9zM5.2 4A1.6 1.6 0 1 0 5.2 7.2 1.6 1.6 0 0 0 5.2 4zM20 20h-2.5v-5.6c0-1.6-.6-2.4-1.7-2.4-1.2 0-1.8.8-1.8 2.4V20H11.5V9H14v1.2A3.3 3.3 0 0 1 17 9c2.4 0 3 1.6 3 4.6V20z" />
    </svg>
  );
}
...
export function MessageSquare({ className }) {
  return (
    <svg className={className} {...svgProps}>
